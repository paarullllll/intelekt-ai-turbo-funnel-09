        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-white/70 hover:text-white transition-colors">Data Processing</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 text-center md:text-left">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mt-4 md:mt-0">
              <a href="#" className="text-intelekt-cta hover:text-intelekt-cta/80 text-sm font-medium transition-colors">
                support@intelektai.com
              </a>
            </div>
          </div>
        </div>
