  ...
  const steps = [
    {
      ...
      interaction: "Callers dial into a system and are met with a pre-recorded menu of options (e.g., 'Press 1 for Sales, Press 2 for Support')",
      limitations: "Static, slow, non-interactive. Users often get frustrated by long menus and irrelevant options."
    },
    {
      ...
      interaction: "Callers can now speak basic commands like 'Sales' or 'Support' instead of pressing buttons.",
      limitations: "Limited vocabulary and poor understanding of natural language. Misinterpretation of user input remains a common issue."
    },
    {
      ...
      interaction: "AI recognizes and processes more complex, natural language phrases (e.g., 'I need help with my billing').",
      limitations: "Voice AI can understand intent, answer more dynamic queries, and route calls more intelligently."
    },
    {
      title: "Agentic AI",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            Journey from old IVRs to <span className="text-intelekt-cta">Intelekt's Agentic AI</span> workflows
          </h2>
          <p className="text-lg text-white/80 max-w-3xl mx-auto">
            See the transformation from rigid menu systems to intelligent, conversational AI agents
          </p>
        </motion.div>
            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                <div className={cn(
                  ...
                  <p className="text-sm text-intelekt-cta mb-4">{step.subtitle}</p>
                  
                  <div className="mb-4">
                    <h4 className="text-white/90 font-medium text-sm mb-2">User Interaction</h4>
                    <p className="text-white/70 text-sm">{step.interaction}</p>
                  </div>
                  
                  <div>
                    <h4 className="text-white/90 font-medium text-sm mb-2">Limitations</h4>
        ...
        >
          <p className="text-lg text-intelekt-cta font-medium">
            This progression shows the shift from rigid, menu-based interactions to flexible, intelligent voice AI systems capable of personalized, dynamic, and human-like conversation ability.
          </p>
        </motion.div>
      </div>
    </section>
